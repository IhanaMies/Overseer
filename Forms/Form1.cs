...
namespace Overseer
{
    public partial class Form1 : Form
    {
        ...
        public void PopulateItemList()
        {
            ...
            dataGridView1.CellMouseDown += new DataGridViewCellMouseEventHandler(OnCellMouseDown);
            dataGridView1.DragLeave += new EventHandler(OnDragLeave);
        ...
        {
            Console.WriteLine("dataGridView DragLeave event");
        }
        private void OnCellMouseDown(object sender, DataGridViewCellMouseEventArgs e)
        {
            Console.WriteLine("dataGridView OnCellMouseDown event");
            mouseDownObject = dataGridView1.Rows[e.RowIndex].Cells[2].Value as Item;
            dataGridView1.DoDragDrop(mouseDownObject, DragDropEffects.Copy);
        }
        private void OnCellMouseClicked(object sender, DataGridViewCellMouseEventArgs e)
        {
            Console.WriteLine("dataGridView OnCellMouseClick event");
        }
        ...
        {
            ModHandling.InitializeDataBackgroundWorker();
        }
